"""Capture full visible prose from the browser shell for Step 31D.

This script drives the real browser shell, reads the rendered presentation cards,
and writes artifacts for qualitative copy review. It does not change engine
behavior, retrieval, schema, or presentation copy generation.

Usage:
    PYTHONPATH=. python -m app.scripts.run_browser_smoke_step31d
"""
...
def main() -> int:
    ...
    parser.add_argument("--json-out", default="artifacts/browser_smoke_step31D.json")
    parser.add_argument("--md-out", default="artifacts/browser_smoke_step31D.md")
...
def _run_browser_capture(base_url: str) -> dict[str, Any]:
    ...
    return {
        "step": "31D",
        "title": "Browser smoke full visible prose capture",
        ...
        "warnings": warnings,
        "cases": results,
        "note": "No copy refinement was performed. This artifact captures current visible prose for review.",
    }
...
def _run_case(page: Page, base_url: str, case_id: str, prompt: str) -> dict[str, Any]:
    ...
    try:
        ...
        page.wait_for_selector("text=Analysis Result", timeout=150000)
...
def _markdown_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Step 31D Browser Smoke Full Prose Capture",
        "",
        "No copy refinement was performed. This artifact captures current visible browser prose for qualitative review.",
        "",
        "## Summary",
        "",
